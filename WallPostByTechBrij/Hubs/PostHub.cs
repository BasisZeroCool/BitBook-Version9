    ...
    public class PostHub : Hub
    {
        ...
        public void GetPosts()
        {
            using (WallEntities db = new WallEntities())
            {
                ...
                List<Post> GetPostListBymeAndMyFriend = aManager.GetPostList();
                var ret = (from post in GetPostListBymeAndMyFriend
        ...
        public dynamic AddLike(Like like)
        {
            ...
            using (WallEntities db=new WallEntities())
            {
                var usr = db.UserProfiles.FirstOrDefault(x => x.UserId == like.LikeBy);
                LogicManager aManager=new LogicManager();
